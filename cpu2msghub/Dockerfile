...
ENV HORIZON_PATTERN='{"id":"cpu2msghub","org":"IBM","url":"github.com.open-horizon.examples.cpu2msghub"}'
...
LABEL \
    ...
    org.label-schema.usage="https://github.com/dcmartin/hassio-addons/cpu2msghub/tree/master/README.md" \
    org.label-schema.vcs-ref=${BUILD_REF} \
    org.label-schema.vcs-url="https://github.com/dcmartin/hassio-addons/cpu2msghub" \
